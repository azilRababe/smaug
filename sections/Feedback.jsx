    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-[#ff5722]">
            Awaken the Flame Within
          </p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          “Deep in the shadows of comfort, strength was forgotten. But the flame
          never died. It waited... Now it’s your time to rise.”
        </p>
      </motion.div>
